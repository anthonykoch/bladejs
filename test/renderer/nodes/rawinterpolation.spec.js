...
test('Renderer - rendered interpolation simple', (assert) => {
	const options = {};
...
test('Renderer - rendered interpolation scope variables', (assert) => {
	const options = {};
...
test('Renderer - rendered interpolation does not escape output', (assert) => {
	const options  = {};
	const locals   = {};
	const data     = `{!! '&<>"' !!}`;
	const expected = `&<>"`;
